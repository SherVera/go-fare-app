  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <ScreenHeader title="Verificación de Identidad" />
        ...
        >
          ...
          <View style={styles.titleBlock}>
            <Text style={styles.titleDark}>Valida tu</Text>
            <Text style={styles.titleBlue}>Cédula</Text>
            <Text style={styles.subtitle}>
              Ingrese su número de cédula para{'\n'}continuar de forma segura.
            </Text>
          </View>
          ...
          >
            <Text style={styles.ctaText}>Validar Identidad</Text>
